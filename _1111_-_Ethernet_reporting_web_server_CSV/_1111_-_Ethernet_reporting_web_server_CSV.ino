/*  1111 - The Ethernet Shield (W5100) simple reporting web server with CSV output
 * 
 ...
 * 
 * Instead of this output to be formatted with HTML, it is returned to the
 * client in CSV (comma-separated values) format. This format is a common
 * way to transfer data between IoT applications.
 * 
