/*  1240c - Adafruit Bluefruit HID Keyboard
 * 
 * This sketch shows you how to convert your Bluefruit-equiped Arduino to a Bluetooth 
 * keyboard.
 * 
 * This sketch uses software serial connection between the module and the Arduino.
 * Please see below for wiring information.
 * 
 * Once you have the connections completed, upload this sketch. Connect your phone to
 * the module via Bluetooth, and start a note-taking app on it. Once connected, the 
 * Arduino will start typing messages to your phone, which will appear in the note-taking
 * app. 
 * 
...
void loop(void)
{
  ...
  message =  message + "\\r\\n";
  message.toCharArray(keys,message.length());
