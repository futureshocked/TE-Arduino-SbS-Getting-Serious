/*  0850 - Adafruit Neopixel RGBW 30 LED strip example sketch
 * 
 ...
 * ----------
 *  - Arduino Uno
 *  - Adafruit Neopixel RGBW 30 LED strip
 *  
 *  
 *  Libraries
 *  ---------
 ...
 *  
 *  Created on April 5 2017 by Peter Dalmaris
 * 
 */
...
void loop() {
  ...
  colorWipe(strip.Color(255, 255, 255, 255), 50); // Red
...
//   strip.setPixelColor(3, strip.Color(50, 0, 0, 50));
//    strip.show();
}
