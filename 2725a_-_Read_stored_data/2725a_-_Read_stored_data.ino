/*  2725a - Read stored data
 * 
 * This sketch shows you how to to read data stored in 
 * specific blocks of an RFID tag. 
 * 
 * Use this sketch along side sketch 2725b, which allows
 * you to write data to specific blocks of an RFID tag.
 * 
 * 
 * Components
 * ----------
